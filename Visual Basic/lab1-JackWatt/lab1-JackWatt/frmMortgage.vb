...
Public Class frmMortgage
    Const LOAN_MIN As Integer = 10000
    Const LOAN_MAX As Integer = 500000
    Const INTEREST_MIN As Integer = 0
    Const INTEREST_MAX As Integer = 15
    Const DURATION_MIN As Integer = 60
    ...
    Private Sub calculatePayment()
        ...
        lblPayment.Text = lblPayment.Text + " " + FormatCurrency(Convert.ToString(payment), 2)
        lblTotalInterest.Text += " " + FormatCurrency(Convert.ToString(totalInterest), 2)
