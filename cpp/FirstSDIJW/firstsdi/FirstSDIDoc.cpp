...
void CFirstSDIDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CFirstSDIDoc::InitializeSearchContent()
{
...
void CFirstSDIDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
