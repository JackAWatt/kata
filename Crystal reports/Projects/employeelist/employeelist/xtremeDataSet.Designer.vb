...
Partial Public Class xtremeDataSet
    ...
    Partial Public Class EmployeeDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddEmployeeRow(ByVal Last_Name As String, ByVal First_Name As String, ByVal Position As String, ByVal Home_Phone As String, ByVal Extension As String, ByVal Salary As Decimal) As EmployeeRow
            Dim rowEmployeeRow As EmployeeRow = CType(Me.NewRow,EmployeeRow)
            Dim columnValuesArray() As Object = New Object() {Last_Name, First_Name, Position, Home_Phone, Extension, Salary}
...
Namespace xtremeDataSetTableAdapters
    ...
    Partial Public Class EmployeeTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Employee` (`Last Name`, `First Name`, `Position`, `Home Phone`, `Ext"& _ 
                "ension`, `Salary`) VALUES (?, ?, ?, ?, ?, ?)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.employeelist.MySettings.Default.xtremeConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT [Last Name], [First Name], [Position], [Home Phone], Extension, Salary FRO"& _ 
                "M Employee"
        ...
        Public Overloads Overridable Function Insert(ByVal Last_Name As String, ByVal First_Name As String, ByVal Position As String, ByVal Home_Phone As String, ByVal Extension As String, ByVal Salary As Global.System.Nullable(Of Decimal)) As Integer
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(3).Value = CType(Home_Phone,String)
            End If
