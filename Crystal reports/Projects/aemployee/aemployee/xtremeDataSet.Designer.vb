...
Partial Public Class xtremeDataSet
    ...
    Partial Public Class EmployeeDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddEmployeeRow(ByVal Employee_ID As Integer, ByVal Last_Name As String, ByVal First_Name As String, ByVal Position As String, ByVal Extension As String, ByVal Photo() As Byte, ByVal Salary As Decimal) As EmployeeRow
            Dim rowEmployeeRow As EmployeeRow = CType(Me.NewRow,EmployeeRow)
            Dim columnValuesArray() As Object = New Object() {Employee_ID, Last_Name, First_Name, Position, Extension, Photo, Salary}
    ...
    Partial Public Class EmployeeTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Employee` WHERE ((`Employee ID` = ?) AND ((? = 1 AND `Last Name` IS "& _ 
                ...
                "D `Extension` IS NULL) OR (`Extension` = ?)) AND ((? = 1 AND `Salary` IS NULL) O"& _ 
                "R (`Salary` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Employee` (`Employee ID`, `Last Name`, `First Name`, `Position`, `Ex"& _ 
                "tension`, `Photo`, `Salary`) VALUES (?, ?, ?, ?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Employee` SET `Employee ID` = ?, `Last Name` = ?, `First Name` = ?, `Posi"& _ 
                "tion` = ?, `Extension` = ?, `Photo` = ?, `Salary` = ? WHERE ((`Employee ID` = ?)"& _ 
                " AND ((? = 1 AND `Last Name` IS NULL) OR (`Last Name` = ?)) AND ((? = 1 AND `Fir"& _ 
                "st Name` IS NULL) OR (`First Name` = ?)) AND ((? = 1 AND `Position` IS NULL) OR "& _ 
                "(`Position` = ?)) AND ((? = 1 AND `Extension` IS NULL) OR (`Extension` = ?)) AND"& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.aEmployee.My.MySettings.Default.xtremeConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT [Employee ID], [Last Name], [First Name], [Position], Extension, Photo, Sa"& _ 
                "lary FROM Employee"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Employee_ID As Global.System.Nullable(Of Integer), ByVal Original_Last_Name As String, ByVal Original_First_Name As String, ByVal Original_Position As String, ByVal Original_Extension As String, ByVal Original_Salary As Global.System.Nullable(Of Decimal)) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Employee_ID As Global.System.Nullable(Of Integer), ByVal Last_Name As String, ByVal First_Name As String, ByVal Position As String, ByVal Extension As String, ByVal Photo() As Byte, ByVal Salary As Global.System.Nullable(Of Decimal)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Employee_ID As Global.System.Nullable(Of Integer), ByVal Last_Name As String, ByVal First_Name As String, ByVal Position As String, ByVal Extension As String, ByVal Photo() As Byte, ByVal Salary As Global.System.Nullable(Of Decimal), ByVal Original_Employee_ID As Global.System.Nullable(Of Integer), ByVal Original_Last_Name As String, ByVal Original_First_Name As String, ByVal Original_Position As String, ByVal Original_Extension As String, ByVal Original_Salary As Global.System.Nullable(Of Decimal)) As Integer
            If (Employee_ID.HasValue = true) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Last_Name As String, ByVal First_Name As String, ByVal Position As String, ByVal Extension As String, ByVal Photo() As Byte, ByVal Salary As Global.System.Nullable(Of Decimal), ByVal Original_Employee_ID As Global.System.Nullable(Of Integer), ByVal Original_Last_Name As String, ByVal Original_First_Name As String, ByVal Original_Position As String, ByVal Original_Extension As String, ByVal Original_Salary As Global.System.Nullable(Of Decimal)) As Integer
            Return Me.Update(Original_Employee_ID, Last_Name, First_Name, Position, Extension, Photo, Salary, Original_Employee_ID, Original_Last_Name, Original_First_Name, Original_Position, Original_Extension, Original_Salary)
        End Function
    End Class
